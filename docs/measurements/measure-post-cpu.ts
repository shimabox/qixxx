// HISTORICAL HARNESS for the Paid synchronous-verification version of
// POST /api/scores. It cannot run against the current asynchronous API because
// the request contract and processing path have changed.
//
...
// Free-tier non-viability was already established by real Cloudflare
