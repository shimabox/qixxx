// Name / X-handle validation for POST /api/scores (docs/plans/2026-08-16-
// score-ranking task 3's confirmed spec). Pure — no Request/KV dependency —
...
// enough to keep the ranking overlay's row layout predictable (task 4).
...
// unrestricted, per the confirmed spec ("Unicode は許可"). Written with
...
// Twitter/X's own handle character set (docs/plans/2026-08-16-score-ranking
// task 3's confirmed spec), checked *after* stripping a single leading '@'
