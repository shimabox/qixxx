...
// atomic INSERT. Concurrent requests must not exceed either pending cap.
// These tests submit multiple requests to a real wrangler local D1 instance
// and assert that the global and per-IP limits hold under contention.
// Uses the SAME real local D1 test harness the audit
